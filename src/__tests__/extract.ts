...
test('extracts tweet from basic tweet', () => {
    ...
    expect(tweet.datetime).toEqual(new Date("2024-10-03T14:07:42.000Z"));
...
test('extracts tweet from qt tweet', () => {
    ...
    expect(tweet.datetime).toEqual(new Date("2024-10-03T18:41:32.000Z"));
    ...
    expect(tweet.qt?.datetime).toEqual(new Date("2024-10-03T18:38:33.000Z"));
